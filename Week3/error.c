...
void error(ErrorCode err, int lineNo, int colNo) { // dua ra vi tri loi va cac thong bao loi
  switch (err) {
...
void missingToken(TokenType tokenType, int lineNo, int colNo) { // thieu token o vi tri nao
